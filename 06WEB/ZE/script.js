document.addEventListener('DOMContentLoaded', () => {
    function atualizarTotal() {
        const produtos = document.querySelectorAll('.produto1, .produto2, .produto3, .produto4');
        let total = 0;
        ...
        produtos.forEach(produto => {
            ...
            produto.querySelector('.produto-valor').textContent = `R$ ${valorTotalProduto.toFixed(2).replace('.', ',')}`;
